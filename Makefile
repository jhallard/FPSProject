...
FPSProject-Linux-Debug:
	 $(PROJECTBUILD) FPSProject Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

FPSProject-Linux-DebugGame:
	 $(PROJECTBUILD) FPSProject Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

FPSProject-Linux-Shipping:
	 $(PROJECTBUILD) FPSProject Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

FPSProject-Linux-Test:
	 $(PROJECTBUILD) FPSProject Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

FPSProject:
	 $(PROJECTBUILD) FPSProject Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

FPSProjectEditor-Linux-Debug:
	 $(PROJECTBUILD) -editorrecompile  FPSProjectEditor Linux Debug  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

FPSProjectEditor-Linux-DebugGame:
	 $(PROJECTBUILD) -editorrecompile  FPSProjectEditor Linux DebugGame  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

FPSProjectEditor-Linux-Shipping:
	 $(PROJECTBUILD) -editorrecompile  FPSProjectEditor Linux Shipping  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

FPSProjectEditor-Linux-Test:
	 $(PROJECTBUILD) -editorrecompile  FPSProjectEditor Linux Test  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

FPSProjectEditor:
	 $(PROJECTBUILD) -editorrecompile  FPSProjectEditor Linux Development  -project="\"$(GAMEPROJECTFILE)\"" $(ARGS)

configure:
	xbuild /property:Configuration=Development /property:TargetFrameworkVersion=v4.0 /verbosity:quiet /nologo $(UNREALROOTPATH)/Engine/Source/Programs/UnrealBuildTool/UnrealBuildTool_Mono.csproj
