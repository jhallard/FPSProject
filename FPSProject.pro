...
unrealRootPath=/media/jhallard/linux/UnrealEngine
FPSProjectRootPath=/media/jhallard/linux/Unreal Projects/FPSProject

gameProjectFile=/media/jhallard/linux/Unreal Projects/FPSProject/FPSProject.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(FPSProjectSource.pri)
include(FPSProjectHeader.pri)
include(FPSProjectConfig.pri)
include(FPSProjectIncludes.pri)
include(FPSProjectDefines.pri)
...
FPSProject-Linux-Debug.commands = $$build  -project="\"$$gameProjectFile\"" FPSProject Linux Debug $$args
FPSProject-Linux-DebugGame.commands = $$build  -project="\"$$gameProjectFile\"" FPSProject Linux DebugGame $$args
FPSProject-Linux-Shipping.commands = $$build  -project="\"$$gameProjectFile\"" FPSProject Linux Shipping $$args
FPSProject-Linux-Test.commands = $$build  -project="\"$$gameProjectFile\"" FPSProject Linux Test $$args
FPSProject.commands = $$build  -project="\"$$gameProjectFile\"" FPSProject Linux Development $$args

FPSProjectEditor-Linux-Debug.commands = $$build  -editorrecompile -project="\"$$gameProjectFile\"" FPSProjectEditor Linux Debug $$args
FPSProjectEditor-Linux-DebugGame.commands = $$build  -editorrecompile -project="\"$$gameProjectFile\"" FPSProjectEditor Linux DebugGame $$args
FPSProjectEditor-Linux-Shipping.commands = $$build  -editorrecompile -project="\"$$gameProjectFile\"" FPSProjectEditor Linux Shipping $$args
FPSProjectEditor-Linux-Test.commands = $$build  -editorrecompile -project="\"$$gameProjectFile\"" FPSProjectEditor Linux Test $$args
FPSProjectEditor.commands = $$build  -editorrecompile -project="\"$$gameProjectFile\"" FPSProjectEditor Linux Development $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	FPSProject-Linux-Debug \
	FPSProject-Linux-DebugGame \
	FPSProject-Linux-Shipping \
	FPSProject-Linux-Test \
	FPSProject \
	FPSProjectEditor-Linux-Debug \
	FPSProjectEditor-Linux-DebugGame \
	FPSProjectEditor-Linux-Shipping \
	FPSProjectEditor-Linux-Test \
	FPSProjectEditor \
